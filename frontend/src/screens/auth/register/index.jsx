...
const SignUp = ({ navigation }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    phone: Yup.string()
      ...
      .matches(/^(078|073|072)\d{7}$/, 'Invalid phone number'),
    nationalId: Yup.string()
      .required('National ID is required')
      .matches(/^\d{16}$/, 'Invalid national ID'),
              ...
              <View style={tw`px-6 py-2`}>
                ...
                <View style={tw`mt-8`}>
                  ...
                  <View style={tw`mt-4 flex-row justify-center`}>
                    <Text style={tw`text-xl text-gray-500 mx-2`}>
                      Have account?
                    </Text>
                    <Pressable onPress={() => navigation.navigate("Login")}>
                      <Text style={tw`text-xl underline text-[#193074]`}>
                        Login
                      </Text>
                    </Pressable>
                  </View>
