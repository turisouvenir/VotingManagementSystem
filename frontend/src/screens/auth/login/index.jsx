          ...
          <View style={tw`px-6 py-2`}>
            ...
            <View style={tw`mt-8`}>
              ...
              <View style={tw`mt-4 flex-row justify-center`}>
                <Text style={tw`text-xl text-gray-500 mx-3`}>Have no account?</Text>
                <Pressable onPress={() => navigation.navigate('Register')}><Text style={tw`text-xl underline text-[#193074]`}>Register</Text></Pressable>
              </View>
